...
Behavioral Cloning (BC) sidesteps these constraints by \highlight{casting control as an imitation learning problem}, leveraging previously collected expert demonstrations to anchor the learned autonomous behavior.
